$(document).ready(function(){
	...
	if($('.our-achievement-counter-blk').length) {
		var oTop = $('.our-achievement-counter-blk').offset().top - window.innerHeight;
	}
...
// },3000);
	...
	$('.tabber-mob-view ul li a').click(function(){
        ...
        $('.job-program-tabber').click(function(){
            ...
            if (value == 'all') {
                ...
                $('.job-program-box').not('.'+value).hide();
                $('.job-program-box').filter('.'+value).show();
            } 
        });	
    });
	...
	$('.course-accordion-btn').click(function() {
		...
		$(this).parent('.course-accordion-section').siblings().find('.course-accordion-content').slideUp();
		$(this).find('.course-accordion-icon').toggleClass('rotate-accordion-icon');
		$(this).parents('.course-accordion-section').siblings().find('.course-accordion-icon').removeClass('rotate-accordion-icon');
	});
	...
	$('.courses-grid-img').click(function(){
		...
		$('.course-download-img').find('img').attr('src', 'assets/images/filter-download.svg');
	});
	$('.course-download-img').click(function(){
		...
		$('.courses-grid-img').find('img').attr('src', 'assets/images/course-grid-image-blue.svg');
	});
